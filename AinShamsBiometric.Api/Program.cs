...
builder.Services.AddControllers()
    .AddJsonOptions(o =>
    {
        ...
        o.JsonSerializerOptions.PropertyNamingPolicy = null; // keep your attribute names verbatim
    });
...
builder.Services.AddOpenApi(options =>
{
    ...
    options.AddDocumentTransformer((document, context, cancellationToken) =>
    {
        document.Info = new()
        {
            ...
            Description =
                        """
                        > This API provides **comprehensive biometric services** for students, including:
                        > - ICAO compliance checks  
                        > - Fingerprint capture  
                        > - National ID scanning  

                        It is designed for **high accuracy, advanced filtering**, and **seamless integration** into your applications.  

                        ---

                        [![Run in Postman](https://run.pstmn.io/button.svg)](https://god.gw.postman.com/run-collection/9136127-55d2bde1-a248-473f-95b5-64cfd02fb445?action=collection%2Ffork&collection-url=entityId%3D9136127-55d2bde1-a248-473f-95b5-64cfd02fb445%26entityType%3Dcollection%26workspaceId%3D78beee89-4238-4c5f-bd1f-7e98978744b4#?env%5BBolt%20Sandbox%20Environment%5D=)
...
if (app.Environment.IsDevelopment())
{
    ...
    app.MapScalarApiReference(options =>
    {
        ...
        .WithLayout(ScalarLayout.Classic) //Classic, Modern
        .WithDarkMode(true)
